...
|----------------+-------------------------------------------|
- Assignments can be [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][downloaded from here]].
...
|--------+-------------------------------------------------------------------------------------------------------+-------|
| Mar 31 | SUBMIT 2-3 page detailed report discussing overall approach, idealizations, etc. required for project |    20 |
|--------+-------------------------------------------------------------------------------------------------------+-------|
...
- Gauss quadrature
** [L7] Jan 29, Thu
- *Assignment 1* [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][download here]] (due 5 Feb)
- Construction of 1D shape functions
- Error computations and convergence
- Computer implementation of 1D FEM
** [L8] Feb 03, Tue
- Discussion of 1D FEM code ([[https://drive.google.com/file/d/1wyo4cMIerxot89Bswj2Cl2YgpTR8OQL4/view?usp=sharing][download here]])
- Error computation and convergence behavior
- Importance of mesh convergence studies
** [L9] Feb 05, Thu
- *Assignment 2* [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][download here]] (due 12 Feb)
...
** [L11] Feb 12, Thu
- *Assignment 3* [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][download here]] (due 19 Feb)
- Treatment of boundary integral in 2D problems
** [L12] Feb 17, Tue
...
** [L14] Mar 10, Tue
- Solution of mid-semester exam.
** [L15] Mar 12, Thu
- Time-marching methods for parabolic and hyperbolic equations.
** [L16] Mar 17, Tue
- Time-marching methods for parabolic and hyperbolic equations.
- Generalized eigenvalue problem associated with the FE matrices. Stability and convergence criteria.
** [L17] Mar 19, Thu
...
- Minimization of functionals
** [L19] Mar 26, Thu
- *Assignment 4* [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][download here]] (due 02 Apr)
- 1D functionals and considering the energy formulations
- 2D functionals
** Mar 31, Tue - no class
- Maharvir Jayanti
** [L20] Apr 02, Thu
- Continuum vs. structural elements
- Matrix stiffness method as a special case of FEM
- A different view of creating shape functions
- Higher degree elements.
** [L21] Apr 07, Tue
- A different view of creating shape functions
- Creating higher degree elements with selective edges being nonlinear
- 2D triangular element (CST, LST); creating triangle element as a degenerate quad element
- 3D shape functions and elements (hexahederal, tetrahederal, others)
- Limitations of single field methods (incompressible materials in elasticity formulation)
** [L22] Apr 09, Thu
- *Assignment 5* [[https://drive.google.com/drive/folders/1ePNIzgNZoYzgIcgj61yzIj67bbo3sGJ9?usp=drive_link][download here]] (due 16 Apr)
- 3D elasticity and 2D idealizations.
- Variational principles (Hellinger-Reissner and Hu-Washizu) for multi-field formulations
- Proof for natural BCs arising out of minimization of functionals
** [L23] Apr 14, Tue
...
** [L24] Apr 16, Thu
- Project presentations (8 minutes per group)
** [L25] Apr 21, Tue
- Numerical artifacts in different FE elements; modes of elements, rigid body modes
- Locking behavior and issues with incompressible materials; B-bar method
** [L26] Apr 23, Thu
- Numerical artifacts in different FE elements; modes of elements, rigid body modes
- Locking behavior and issues with incompressible materials; B-bar method
