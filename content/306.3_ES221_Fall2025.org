...
Marks out of 100: Maximum: 95, Average: 54.26, Standard Deviation: 29.10
...
- /Assignment 6/ given (due on 28 Oct).
** [T10] Oct 22, Wed
...
- /Reading from the book (B2)/: Chapter 9.
- /Assignment 7/ given (due on 4 Nov).
# - /In-class submission C3/
** [T11] Oct 29, Wed
- Mohr's circle for stress transformation.
** [L19] Oct 31, Fri
- Mohr's circle for 2D strain transformation.
- Generalized Hooke's law for triaxial loading and thermal effects.
- Young's modulus, Shear modulus, Bulk modulus and their relationship.
...
- Failure theories
  - Maximum shear stress theory (Tresca criteron)
  - Maximum distortion energy theory (Mises-Huber criterion)
  - Maximum normal stress theory (Rankine theory, Mohr-Coulomb criteron)
...
- Deflections of beams by double integration method.
- /Reading from the book (B2)/: Chapter 12.
- /Assignment 8/ given (due on 18 Nov).
** [T12] Nov 12, Wed
- Failure theories, beam deflections.
** [L23] Nov 14, Fri
- Deflections of beams.
- Macaulay functions / singularity functions.
- Strain energy and complimentary strain energy.
- Conservation of energy.
- Useful video on Macaulay's method / Singularity functions: https://www.youtube.com/watch?v=m5-iJGY7k_8&list=PLKg8NoX0BvK3NuUsHHFGsEV4bZ2UkPFa7&index=7
- /Reading from the book (B2)/: Chapters 12 and 14.
** [L24] Nov 18, Tue
- Castigliano's theorems.
- Deflections of indeterminate problems.
- Stability of equilibrium.
- Buckling of slender members.
- General state of plane strain and strain-displacement relations. Strain rosette.
- /Reading from the book (B2)/: Chapters 10, 12, 13 and 14.
** [T13] Nov 19, Wed
- Deflections of beams. Strain energy, stability.
** Nov 21 - 28: End semester exam week
*** Nov 22, Sat, 14:00-16:00 -- End Semester Exam -- AB 11/102
Marks out of 100: Maximum: 94, Average: 60.75, Standard Deviation: 26.53
