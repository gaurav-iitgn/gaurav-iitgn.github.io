...
** L4: 11 August, Thursday
 - Solution of an assembly of truss members using stiffness matrix method.
...
** 12 August, Friday
 - Stiffness matrix of 1D bar element. Eigenvalue, eigenvectors and other properties of stiffness matrix. Assembly.
- Stiffness of a beam element. Beams under different loading conditions - solution by stiffness matrix method.
